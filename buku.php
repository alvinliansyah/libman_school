							...
							<tbody>
								<tr>
									...
									<div class="btn-group" role="group" aria-label="Basic mixed styles example">
											<strong><button type="button" class="btn btn-primary" style="border-radius: 10px 0px 0px 10px;"><a href="detailBuku.php?id=<?=$row['kd_buku'];?>" style= "color:white; text-decoration: none; font-weight: normal;"><i class='bx bx-show-alt icon'></i></a></strong></button>
