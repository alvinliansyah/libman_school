...
if (isset($_POST['button-submittambahdata1'])) {
  ...
  $tambah=mysqli_query($koneksi, "INSERT INTO data_siswa(NIS, nama_siswa, data_siswa.password, tingkatan, kelas, notelp) 
  VALUES ('$nis','$nama','$pass','$tingkatann','$kelass','$nomer')");
  if($tambah){
